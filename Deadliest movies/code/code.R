...
#' 
#' **Description:** This script generates a pretty barchart representing the top 25 most violent movies ordered by number of on screen deaths per minute. For more information, see http://www.theswarmlab.com/r-vs-python-round-1/
#' 
